...
describe("PATCH /api/v1/users/[username]", () => {
  ...
  describe("Default user", () => {
    ...
    test("With duplicated `username`", async () => {
      await orchestrator.createUser({
        username: "user1",
        email: "user1l@email.com",
      });

      const createdUser2 = await orchestrator.createUser({
        username: "user2",
        email: "user2l@email.com",
      });
    ...
    test("With duplicated 'email'", async () => {
      await orchestrator.createUser({
        email: "email1l@email.com",
      });

      const createdUser2 = await orchestrator.createUser({
        email: "email2l@email.com",
      });
    ...
    test("With unique 'email'", async () => {
      ...
      expect(userInDatabase.email).toBe("uniqueEmail2l@email.com");
    });
  ...
  describe("Privileged user", () => {
    test("With `update:user:other` targeting `defalutUser`", async () => {
